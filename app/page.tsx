  ...
  return (
    <div className="w-full max-w-2xl flex flex-col gap-3">
      ...
      <p className="text-center text-xs text-[rgba(55,50,47,0.55)] font-sans">
        Free streaming chat — no account needed.{" "}
      ...
      <div className="w-full max-w-[1060px] relative pt-[9px]">
        ...
        <section className="pt-24 sm:pt-28 lg:pt-36 pb-10 px-4 sm:px-6 lg:px-0 flex flex-col items-center gap-6 border-b border-[rgba(55,50,47,0.12)]">
          ...
          <p className="text-[11px] text-[rgba(55,50,47,0.40)] font-sans text-center max-w-lg text-balance">
            ...
            access is sold here; the free chat is this site&rsquo;s own assistant, not the Fable 5 model itself.
          </p>
        </section>
        ...
        <div id="features" className="w-full">
          <FeatureHighlight
            ...
            description="Claude-style, full-screen streaming chat: Markdown answers and history saved in your browser. No account, no cost — practice your Fable 5 prompt ideas live before spending tokens."
            visual={<ChatPreview />}
          />
